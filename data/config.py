...
dataset_base = Config({
    ...
    'train_images': './myData/coco/images/',
    'train_info':   './myData/coco/annotations/annotations_train.json',

    # Validation images and annotations.
    'valid_images': './myData/coco/images/',
    'valid_info':   './myData/coco/annotations/annotations_val.json',
